...
<head>
    ...
    <img src="/web/marx/Public/images/head.png" alt="headimg" width="100%">
    ...
    <div class="toplink">
        ...
        <li><a href="<?php echo U('Lists/index?cid=27');?>">下载中心</a>
...
<body>
<div>
    <h3><?php echo ($blogs[0]['title']); ?></h3>
    <p><?php echo ($blogs[0]['author']); echo ($blogs[0]['click']); ?></p>
