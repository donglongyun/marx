...
<div class="toplink container col-md-offset-3 col-md-8" style="margin-top: -30px;font-size:15px;">
...
<div class="show" style="overflow: auto"><middle><br>
    ...
    <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 6 );++$i;?><p style="display:none;"><?php echo ($b=$vo["id"]); ?></p>&nbsp;&nbsp;&nbsp;
        <a href="<?php echo U('Show/index?id='.$b);?>"><?php echo ($vo['title']); ?></a>&nbsp;&nbsp;&nbsp;
        <?php if(($mod) == "4"): ?><br/><br/><?php endif; endforeach; endif; else: echo "" ;endif; ?>
</middle></div>
</body>
