...
<html lang="zh-CN">
  <head>
    ...
    <script type="text/javascript">
      function del(id){ 
        if(confirm('确定要删除吗？')){ 
          window.location = "/web/marx/index.php/Admin/First/delBanner?id="+id;
        }
      }
    </script>
  </head>
  ...
  <body>
	<div id="top">
		<a href="/web/marx/index.php/Admin/Index/content"><span class='glyphicon glyphicon-home'></span></a>&nbsp;当前位置：<a href="/web/marx/index.php/Admin/First/banner">首页设置</a>&nbsp;>>&nbsp;<a href="/web/marx/index.php/Admin/First/banner">导航图片</a>
	</div>
	<div id="all" >
		<a class='btn btn-primary' href="/web/marx/index.php/Admin/First/addBanner" style="margin:5px">添加图片</a>
		<form action="/web/marx/index.php/Admin/First/sortBanner" method="post">
			<table class="table table-bordered table-hover" >
				...
				<?php if(is_array($banner)): $i = 0; $__LIST__ = $banner;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
						<td><img src="/web/marx/Public/Uploads/<?php echo ($v["src"]); ?>" width='600px' height='162px'> </td>
						...
						<td>
							[<a href="/web/marx/index.php/Admin/First/updateBanner?id=<?php echo ($v['id']); ?>">修改</a>]
