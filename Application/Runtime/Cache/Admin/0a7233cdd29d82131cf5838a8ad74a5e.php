...
<html lang="zh-CN">
  ...
  <body>
  <div id="top">
  	<a href="/web/marx/index.php?s=/Admin/Index/content"><span class='glyphicon glyphicon-home'></span></a>&nbsp;当前位置：<a href="/web/marx/index.php?s=/Admin/Rbac/index">用户管理</a>&nbsp;>>&nbsp;<?php if($role == null): ?><a href="/web/marx/index.php?s=/Admin/Rbac/addRole">添加角色</a><?php else: ?><a href="/web/marx/index.php?s=/Admin/Rbac/addRole?rid=<?php echo ($role['id']); ?>">配置权限</a><?php endif; ?>
  </div>
	<div id="all" >
