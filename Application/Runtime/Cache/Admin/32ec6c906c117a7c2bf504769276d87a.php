...
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
		...
		<link rel="stylesheet" href="/Application/Admin/View/Public/Css/login.css" />
		<meta http-equiv="Content-Type" content="text/html;charset=utf-8">
		<script type="text/javascript" src="/Application/Admin/View/Public/Js/jquery-1.7.2.min.js"></script>
		<script type="text/javascript" src="/Application/Admin/View/Public/Js/login.js"></script>
		<link rel="stylesheet" href="/Application/Admin/View/Public/Css/bootstrap.min.css" >
 		<link rel="stylesheet" href="/Application/Admin/View/Public/Css/login.css" >
  		<script type="text/javascript">
  			var url = "/index.php?s=/Admin/Login/checkcode";
  		</script>
	</head>
	<body>
		<div id="top">
		...
		<div class="login" style="border-radius:5px">	
			<form action="/index.php?s=/Admin/Login/login" method="post" id="myform">
				<div class="title">
				...
				<table>
					...
					<tr>
						<th>验证码:</th>
						<td>
							<input class="form-control inp_code" type="code" name="code" /> <img src="/index.php?s=/Admin/Login/verify" class="code" onclick='this.src=this.src+"?"+Math.random()'/>
						</td>
					</tr>
