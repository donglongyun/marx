		...
		<link rel="stylesheet" href="/web/marx/Application/Admin/View/Public/Css/bootstrap.min.css" >
 		<link rel="stylesheet" href="/web/marx/Application/Admin/View/Public/Css/login.css" >
  		<script type="text/javascript">
  			var url = "/web/marx/index.php/Admin/Login/checkcode";
  		</script>
	</head>
	<body>
		<div id="top">
		...
		<div class="login" style="border-radius:5px">	
			<form action="/web/marx/index.php/Admin/Login/login" method="post" id="myform">
				<div class="title">
				...
				<table>
					...
					<tr>
						<th>验证码:</th>
						<td>
							<input class="form-control inp_code" type="code" name="code" /> <img src="/web/marx/index.php/Admin/Login/verify" class="code" onclick='this.src=this.src+"?"+Math.random()'/>
						</td>
					</tr>
