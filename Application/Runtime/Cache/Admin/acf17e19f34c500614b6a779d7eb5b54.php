...
<html lang="zh-CN">
  <head>
	...
	<link rel="stylesheet" href="/web/marx/Application/Admin/View/Public/Css/top.css" />
	  ...
	  <script type="text/javascript">
	 		...
	 		function del(id){
        if(confirm('确定要删除吗？')){
          window.location = "/web/marx/index.php?s=/Admin/Rbac/delUser?id="+id;
        }
      }
	  </script>
  </head>
  ...
  <body>
	<div id="top">
  		<a href="/web/marx/index.php?s=/Admin/Index/content"><span class='glyphicon glyphicon-home'></span></a>&nbsp;当前位置：<a href="/web/marx/index.php?s=/Admin/Rbac/index">用户管理</a>&nbsp;>>&nbsp;<a href="/web/marx/index.php?s=/Admin/Rbac/index">用户列表</a>
  	</div>
	<div id="all" >
		<form action="/web/marx/index.php?s=/Admin/Rbac/" method="post">
			<table class="table table-bordered table-hover" >
				...
				<?php if(is_array($user)): foreach($user as $key=>$v): ?><tr>
						...
						<td>
							[<a href="/web/marx/index.php?s=/Admin/Rbac/addUser?id=<?php echo ($v['id']); ?>">修改角色</a>]
							[<a href="/web/marx/index.php?s=/Admin/Rbac/savePass?id=<?php echo ($v['id']); ?>">修改密码</a>]
