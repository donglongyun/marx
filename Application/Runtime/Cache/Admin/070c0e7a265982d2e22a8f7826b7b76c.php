...
<html lang="zh-CN">
  ...
  <style type="text/css">
    ...
    function del(id){
      if(confirm('确定要删除吗？')){
        window.location = "/web/marx/index.php/Admin/Rbac/delRole?rid="+id;
      }
  ...
  <body>
  	<div id="top">
  		<a href="/web/marx/index.php/Admin/Index/content"><span class='glyphicon glyphicon-home'></span></a>&nbsp;当前位置：<a href="/web/marx/index.php/Admin/Rbac/index">用户管理</a>&nbsp;>>&nbsp;<a href="/web/marx/index.php/Admin/Rbac/role">角色列表</a>
  	</div>
	<div id="all" >
